...
class Autopilot(Entity, replaceable=True):
    ...
    def create(self, n=1):
        ...
        self.turn180pref[-n:] = 1.  # default: use system default (clockwise)
...
#
    ...
    def selhdg180cmd(self, idx: 'acid', direction: str = 'CW'):
        ...
        if direction == 'CW':
            self.turn180pref[idx] = 1.0  # clockwise
        elif direction == 'CCW':
            self.turn180pref[idx] = -1.0  # counterclockwise
        else:
    ...
    def setturnpref(self, idx: 'acid', direction: str = None):
        """ TURNPREF acid,[CW/CCW]
            ...
            Set 180-degree turn preference for aircraft.
        ...
        direction = direction.upper()
        if direction == 'CW':
            self.turn180pref[idx] = 1.0
        elif direction == 'CCW':
            self.turn180pref[idx] = -1.0
        else:
            return False, f"Invalid direction '{direction}'. Use 'CW', 'CCW'"
