...
exp_const=0.5 ## we need to think about the value of that constant
...
plan1=PathPlanning(subgraph,edges, start_index,dest_index)
route = plan1.plan()
print(route)
##replan
y_curr=route[0][3][1]
...
edges[curr_index1][curr_index2].max_speed=1
