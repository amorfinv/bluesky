...
experiment_cases = {
    ...
    'graphweights':[
        ...
        # # all clusters get an extra weight
        # '1.5-1.5-1.5',
        # '2-2-2',
        # '2.5-2.5-2.5',
        # '3-3-3',
        ...
        # # 50 percent to 100 percent get extra weight
        # '1-1-1.5',
        # '1-1-2',
        # '1-1-2.5',
        # '1-1-3',

        # # # 75 percent to 100 percent get extra weight MODIFY CODE!!!
        # '1-1-1.5',
        # '1-1-2',
        # '1-1-2.5',
        # '1-1-3',
...
lines = '\n'.join(batch_lines)
with open(f'sensitivitybatch1.scn', 'w') as file:
